...
lstm_net = tflearn.lstm(lstm_net,weights_init='xavier', n_units=lstm_units, return_seq=False)
...
model.fit(trainX, trainY, show_metric=True, batch_size=batch_size, n_epoch=25)
